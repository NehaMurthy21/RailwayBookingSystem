...
<body>
    ...
    <form method="post" action="">
        ...
        <input type="submit" value="Get Past Reservations">
    </form>
...
if (username != null && !username.isEmpty()) {
    ...
    try {
        ...
        // Query to retrieve past reservations
        ...
        boolean hasPastReservations = false; // Flag to check if there are any past reservations
        while (rs.next()) {
            hasPastReservations = true; // Set flag to true if at least one reservation is found
            out.println("<tr>");
            ...
            out.println("<td>" + rs.getDate("date_ticket") + "</td>"); // Use getDate for date only
            out.println("<td>" + rs.getString("status") + "</td>");
            out.println("</tr>");
        }
        if (!hasPastReservations) {
            out.println("<tr><td colspan='6'>No past reservations found.</td></tr>");
        }
        out.println("</table>");
